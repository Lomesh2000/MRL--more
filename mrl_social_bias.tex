...
Permutation significance testing is implemented in the WEAT pipeline (\texttt{step3\_weat.py}; two-tailed permutation test, $N{=}10{,}000$ permutations). The frozen paper evidence currently preserves WEAT effect-size trajectories in JSON; significance values from WEAT runs should be reported in the final camera-ready table from archived run logs or a dedicated significance JSON export.
