...
\midrule
Layer 1 & MPNet baseline metrics & \texttt{step3\_weat.py}, \texttt{step4\_subspace.py}, \texttt{step5\_seat.py} \\
--- & Benchmark artifact generation & \texttt{step5\_stereoset\_v2.py}, \texttt{step6\_crowspairs\_new.py}, \texttt{step7\_all\_results.json} \\
